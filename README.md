...
2. Download the [latest release](https://github.com/Abhinandan-Khurana/aquatone/releases/latest) of Aquatone for your operating system.
...
4. Alternately, Install directly using go - `go install -v github.com/Abhinandan-Khurana/aquatone@v1.7.2`
